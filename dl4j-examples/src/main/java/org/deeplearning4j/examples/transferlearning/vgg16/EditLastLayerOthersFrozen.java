...
public class EditLastLayerOthersFrozen {
    ...
    public static void main(String [] args) throws UnsupportedKerasConfigurationException, IOException, InvalidKerasConfigurationException {
        ...
        TrainedModelHelper modelImportHelper = new TrainedModelHelper(VGG16);
        System.out.println("\n\nLoading vgg16...\n\n");
        ...
        ComputationGraph vgg16Transfer = new TransferLearning.GraphBuilder(vgg16)
            ...
            .addLayer("myff", new DenseLayer.Builder().name("ffn2").nOut(1024).biasInit(0).dropOut(0.5).dist(new GaussianDistribution(0, 0.01)).build())
        ...
        eval = vgg16Transfer.evaluate(testIter2);
        ...
        while(trainMIter.hasNext()) {
            vgg16Transfer.fit(trainMIter.next());
            if (iter % 10 == 0) {
        ...
        File locationToSave = new File("MyLogoGraph.zip");
        ...
        for(int i=0; i < 10; i++) {
            ...
            INDArray out = vgg16Transfer.outputSingle(features);
