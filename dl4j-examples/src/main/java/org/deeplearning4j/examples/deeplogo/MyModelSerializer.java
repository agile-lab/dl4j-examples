...
public class MyModelSerializer{
    public static Logger log  = Logger.getLogger("MyModelSerializer");
    ...
    public static <T extends Normalizer> T restoreNormalizerFromFile(File file) {
        try (ZipFile zipFile = new ZipFile(file)) {
            ...
            log.info("Error while restoring normalizer, trying to restore assuming deprecated format...");
            DataNormalization restoredDeprecated = restoreNormalizerFromFileDeprecated(file);

            log.info("Recovered using deprecated method. Will now re-save the normalizer to fix this issue.");
