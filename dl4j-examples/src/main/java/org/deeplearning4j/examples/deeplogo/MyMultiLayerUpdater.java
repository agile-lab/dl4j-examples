...
//@EqualsAndHashCode
//@Getter
//public class MyMultiLayerUpdater implements Updater {
//    private final Updater[] layerUpdaters;
//    private INDArray viewArray;
//
//    public MyMultiLayerUpdater(MyMultiLayerNetwork network) {
...
//    }
//
//    public MyMultiLayerUpdater(MyMultiLayerNetwork network, INDArray updaterState) {
//        Layer[] layers = network.getLayers();
//        layerUpdaters = new Updater[layers.length];
//
//        int updaterStateSize = 0;
...
//        if (!(other instanceof org.deeplearning4j.nn.updater.MultiLayerUpdater))
//            return false;
//
//        MyMultiLayerUpdater multiLayerUpdater = (MyMultiLayerUpdater) other;
